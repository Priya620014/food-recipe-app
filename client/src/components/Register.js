...
//       <div className="relative flex flex-col md:flex-row w-full max-w-4xl bg-white/40 backdrop-blur-lg border border-[#F4A261] shadow-2xl rounded-2xl overflow-hidden">
